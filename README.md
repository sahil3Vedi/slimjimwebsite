# [SlimJim Website Concept](https://sahil3vedi.github.io/slimjimwebsite)

An HTML starter template for [Bootstrap](http://getbootstrap.com/) created by [Sal Trivedi](http://instagram.com/jonnyshaver). This template features predefined file paths for Bootstrap and jQuery, so you can quickly create Bootstrap websites.
